CLEAN-CITÉ — MISE À JOUR COMPLÈTE AVEC PROSPECTION MULTI-ACTIVITÉS
==================================================================
...
MODULE DE PROSPECTION — VERSION 2
Adresse : https://clean-cite.org/admin/prospection.html

Le module est déjà relié au bouton « Prospection commerciale » du tableau de bord
administrateur. Il n'y a aucun fichier du module à déplacer séparément.

Le module permet de :
• choisir dans une liste : conciergeries Airbnb, syndics de copropriété,
  gestionnaires de copropriété, administrateurs de biens ou agences immobilières ;
• rechercher l’activité choisie par ville, département ou région ;
• enregistrer la catégorie de chaque prospect et filtrer la liste par activité ;
• utiliser automatiquement un premier e-mail et une relance adaptés à l’activité ;
• modifier et enregistrer séparément les messages de chacune des cinq activités ;
...
6. Ouvrir /version.txt et vérifier :
   CLEAN-CITE-PROSPECTION-MULTI-ACTIVITES-V2-2026-09-22
...
8. Ouvrir Admin > Prospection commerciale, choisir une activité dans la liste
   déroulante et lancer une petite recherche test.

MISE À JOUR DEPUIS LA VERSION AIRBNB
Les prospects et les envois déjà enregistrés sont conservés. Les contacts Airbnb
déjà envoyés continuent d’utiliser le message et la relance Airbnb. Un ancien
prospect non envoyé qui ne peut pas être reconnu automatiquement apparaît comme
« À classer » : choisir son activité dans sa fiche avant de l’envoyer.
